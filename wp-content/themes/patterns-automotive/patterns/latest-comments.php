 ...
 * Slug: patterns-automotive/latest-comments
 * Categories: posts
...
<h4 class="wp-block-heading has-base-font-family has-small-font-size" style="margin-bottom:30px"><?php esc_html_e( 'Recent comments', 'patterns-automotive' ); ?></h4>
<!-- /wp:heading -->
