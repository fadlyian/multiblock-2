...
/**
 * Title: Site Identity
 * Slug: patterns-automotive/site-identity
 * Categories: posts
...
<div class="wp-block-group"><!-- wp:site-logo {"width":40,"shouldSyncIcon":true} /-->
	...
	<!-- wp:site-title {"level":0,"style":{"typography":{"textTransform":"uppercase","lineHeight":"1","fontSize":"20px","letterSpacing":"1px"},"spacing":{"margin":{"bottom":"0px"}},"elements":{"link":{":hover":{"color":{"text":"var:preset|color|primary"}}}},"layout":{"selfStretch":"fit","flexSize":null}}} /-->
