...
/**
 * Title: Page Sitemap
 * Slug: patterns-automotive/page-sitemap
 * Post Types: page
...
<div class="wp-block-columns alignwide" style="padding-top:80px;padding-bottom:80px">
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Pages', 'patterns-automotive' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Categories', 'patterns-automotive' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Posts', 'patterns-automotive' ); ?></h4>
			<!-- /wp:heading -->
