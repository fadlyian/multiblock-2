 ...
 * Slug: patterns-automotive/featured-section-1
 * Categories: featured
...
<div class="wp-block-column is-vertically-aligned-center">
	<!-- wp:pattern {"slug":"patterns-automotive/section-title-1"} /-->
<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"bottom":"25px"}},"typography":{"lineHeight":"1.8"}},"textColor":"tertiary"} -->
...
<div class="wp-block-group" style="border-radius:50px"><!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.1"},"elements":{"link":{"color":{"text":"var:preset|color|tertiary"}}}},"textColor":"tertiary","fontSize":"small"} -->
<p class="has-tertiary-color has-text-color has-link-color has-small-font-size" style="line-height:1.1"><?php esc_html_e( 'Call Anytime', 'patterns-automotive' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600","fontSize":"16px"}}} -->
<p style="font-size:16px;font-style:normal;font-weight:600"><?php esc_html_e( '+ 88 ( 9800 ) 6802', 'patterns-automotive' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
